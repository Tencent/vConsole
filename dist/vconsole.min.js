...
/***/ function(module, exports, __webpack_require__) {
	...
	vConsole.prototype._mokeConsole = function () {
	  ...
	  window.console.log = function () {
	    that._printLog('auto', 'log', arguments);
	  };
	  window.console.info = function () {
	    that._printLog('auto', 'info', arguments);
	  };
	  window.console.warn = function () {
	    that._printLog('auto', 'warn', arguments);
	  };
	  window.console.debug = function () {
	    that._printLog('auto', 'debug', arguments);
	  };
	  window.console.error = function () {
	    that._printLog('auto', 'error', arguments);
	  };
