...
/***/ function(module, exports, __webpack_require__) {
	...
	var VConsole = function () {
	  ...
	  _createClass(VConsole, [{
	    ...
	    key: 'showTab',
	    value: function showTab(tabName) {
	      var $logbox = _query2.default.one('#__vc_log_' + tabName);
	      // set actived status
	      _query2.default.removeClass(_query2.default.all('.vc-tab', this.$dom), 'vc-actived');
	      _query2.default.addClass(_query2.default.one('#__vc_tab_' + tabName), 'vc-actived');
