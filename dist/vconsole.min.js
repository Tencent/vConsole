...
/***/ function(module, exports, __webpack_require__) {
	...
	vConsole.addPlugin(_network2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tabbox = __webpack_require__(10);

	var _tabbox2 = _interopRequireDefault(_tabbox);

	var _tool_item = __webpack_require__(11);
	  ...
	  _createClass(VConsole, [{
	    ...
	    value: function _initPlugin(plugin) {
	      ...
	      plugin.trigger('addTool', function (toolList) {
	        ...
	        try {
	          for (var _iterator = toolList[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	            ...
	            if (tool.isFunction(item.onClick)) {
	              _query2.default.bind($item, 'click', item.onClick);
	            }
	    ...
	    value: function showTab(tabID) {
	      ...
	      // show toolbar
	      _query2.default.removeClass(_query2.default.all('.vc-tool', this.$dom), 'vc-actived');
	      _query2.default.addClass(_query2.default.all('.vc-tool-' + tabID, this.$dom), 'vc-actived');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mito = __webpack_require__(25);
	...
	$.delegate = function ($el, eventType, selector, fn) {
	  ...
	  $el.addEventListener(eventType, function (e) {
	    ...
	    try {
	      findTarget: for (var _iterator5 = targets[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tabbox_default = __webpack_require__(18);

	var _tabbox_default2 = _interopRequireDefault(_tabbox_default);

	var _item_code = __webpack_require__(19);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _item_fold = __webpack_require__(16);

	var _item_fold2 = _interopRequireDefault(_item_fold);

	var _item_fold_code = __webpack_require__(17);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tabbox_system = __webpack_require__(21);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tabbox = __webpack_require__(23);
	  ...
	  _createClass(VConsoleNetworkTab, [{
	    ...
	    value: function updateRequest(id, data) {
	      ...
	      if ($old) {
	        ...
	        _query2.default.one('.vc-log', this.$tabbox).appendChild($new);
	      }
	      this.domList[id] = $new;
	      ...
	      window.XMLHttpRequest.prototype.open = function () {
	        ...
	        XMLReq.onreadystatechange = function () {
	          ...
	          if (XMLReq.readyState == 0) {
	            ...
	            try {
	              for (var _iterator = headerArr[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	...
	var tab = new VConsoleNetworkTab('network', 'Network');
