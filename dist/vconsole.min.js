...
/***/ function(module, exports, __webpack_require__) {
	...
	vConsole.prototype._mokeConsole = function () {
	  ...
	  window.console.log = function () {
	    that._printLog('default', 'log', arguments);
	  };
	  window.console.info = function () {
	    that._printLog('default', 'info', arguments);
	  };
	  window.console.warn = function () {
	    that._printLog('default', 'warn', arguments);
	  };
	  window.console.debug = function () {
	    that._printLog('default', 'debug', arguments);
	  };
	  window.console.error = function () {
	    that._printLog('default', 'error', arguments);
	  };
	};
