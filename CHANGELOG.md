...
- `Fix(Core)` Fix switch button not draggable in PC browsers by adding mouse event (`mousedown`/`mousemove`/`mouseup`) support and `user-select: none` to prevent text selection during drag. (issue #677)
